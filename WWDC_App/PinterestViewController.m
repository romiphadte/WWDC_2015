...
-(instancetype)init{
    self=[super initWithNibName:@"PinterestViewController" bundle:nil];
...
-(void)delayAction{
    ...
    CGFloat pheight=230;//.31*height;
    
    
    
    UIView *popUpView=[[UIView alloc] initWithFrame:CGRectMake((1-pwidth)/2, (1-pheight)/2, pwidth, pheight)];
    UIImageView *app_icon=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Pinterest"]];
    ...
    textView.text=@"I will be working for Pinterest in the Summer. I am excited to work on the mobile team and learn how to build great user intefaces and wonderful products loved by millions";
