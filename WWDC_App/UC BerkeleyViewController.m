...
#import "UC BerkeleyViewController.h"
#import <KLCPopup/KLCPopup.h>

@interface UC_BerkeleyViewController ()

@end

@implementation UC_BerkeleyViewController

-(instancetype)init{
    self=[super initWithNibName:@"UC BerkeleyViewController" bundle:nil];
...
-(void)delayAction{
    ...
    CGFloat pheight=230;//.35*height;
    
    
    
    UIView *popUpView=[[UIView alloc] initWithFrame:CGRectMake((1-pwidth)/2, (1-pheight)/2, pwidth, pheight)];
    UIImageView *app_icon=[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"UC_Berkeley"]];
    ...
    textView.text=@"I am a 3rd year Electrical Engineering and Computer Science student at UC Berkeley. Some of my favorite classes are Algorithms, Machine Learning, and Wealth and Poverty";
